...
public class CobbledLimeStoneBlock extends CastleClashModElements.ModElement {
	@ObjectHolder("castle_clash:cobbled_lime_stone")
	public static final Block block = null;
	public CobbledLimeStoneBlock(CastleClashModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobbled_lime_stone");
		}
